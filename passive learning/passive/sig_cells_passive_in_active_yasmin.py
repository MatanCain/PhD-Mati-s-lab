            ...
            for cell_ID in cell_list:
                ...
                for block_inx,(begin_inx,end_inx) in enumerate(zip(block_begin_indexes,block_end_indexes)):
                    ...
                    try:
                        ...
                        dictFilterTrials_washout_test = { 'dir':'filterOff', 'fail':0,'files_begin_end':[file_begin_washout,file_end_washout],'trial_name':'d0'+trial_type_learning_test}
                    ...
                    try:
                        dictFilterTrials_washout_stability = { 'dir':'filterOff', 'fail':0,'files_begin_end':[file_begin_washout,file_end_washout],'trial_name':'d0'+trial_type_learning_test}
                    ...
                    block_dict=dict.fromkeys(['cell_ID','FR learning test','FR washout test','PSTH learning','PSTH washout base','PSTH washout learned','FR learning','FR washout base','FR washout learned','behaviour effect'])
                    block_dict['cell_ID']=cell_ID
                    block_dict['FR learning test']=FR_learning_test           
                    block_dict['FR washout base test']=FR_washout_test  
                    ...
                    block_dict['FR washout base']=FR_learning
                    block_dict['FR washout learned']=FR_washout_learned
                    block_dict['FR learning']=psth_washout_learned
