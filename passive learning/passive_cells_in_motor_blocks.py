...
for learned_direction in learned_direction_array:
    for learning_task2_inx,(cong_task2,incong_task2,motor_task2) in enumerate(zip([cong_task+'_'+learned_direction,cong_task+'_'+learned_direction+'_100_25_cue'],[incong_task+'_'+learned_direction,incong_task+'_'+learned_direction+'_100_25_cue'],[motor_task+'_'+learned_direction,motor_task+'_'+learned_direction+'_100_25_cue'])): 
        ...
        for cell_ID in cur_cell_list: #for cells recorded in both motor and passive
                ...
                for block_inx,(begin_inx,end_inx) in enumerate(zip(block_begin_indexes,block_end_indexes)):
                    ...
                    try:
                        dictFilterTrials_motor = {'dir':'filterOff','fail':0, 'screen_rot':block_base_dir}
...
plt.plot(timecourse,psth_motor,color='tab:green') 

plt.axvline(100,color='black')
plt.axvline(300,color='black') 
plt.legend(['cong','incong','motor'])
plt.title('average')
plt.show()             
